...
import augmentations_w
from augmentations_w.ctaugment import OPS
...
class BaseDataSets1(Dataset):
    def __init__(
        ...
        # random.seed(666)  #@ 注释掉就是原本的2023seed NPC ，如果有这行代码就是NPC1
...
class BaseDataSets2(Dataset):
    def __init__(
        ...
        list_NPC=[]
        with open('/home/whq/HKUSTGZ/Active_L/MADA-main/selection_list/256_SPH_close_APH_ist_0.10.txt', 'r') as file:
            lines = file.readlines()
