...
all_cases = os.listdir(
    "/home/whq/HKUSTGZ/Seg_c/A1.1/data2/{}/imagesTr".format(hopital))
...
with open("/home/whq/HKUSTGZ/Seg_c/A1.1/data2/{}/train.txt".format(hopital), "w") as f1:
    for i in training_set:
        f1.writelines("{}\n".format(i))
f1.close()

with open("/home/whq/HKUSTGZ/Seg_c/A1.1/data2/{}/val.txt".format(hopital), "w") as f2:
    for i in val_set:
        f2.writelines("{}\n".format(i))
f2.close()

with open("/home/whq/HKUSTGZ/Seg_c/A1.1/data2/{}/test.txt".format(hopital), "w") as f3:
    for i in test_set:
        f3.writelines("{}\n".format(i))
f3.close()
